...
public class TestSuite extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() {
        //1.1 clicking on computer and then on desktop option
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        //2.2 clicking on computer and then on desktop option
        Actions actions = new Actions(driver);
        WebElement computer = driver.findElement(By.xpath("//body[1]/div[6]/div[2]/ul[1]/li[1]/a[1]"));
        WebElement desktop = driver.findElement(By.xpath("//body/div[6]/div[2]/ul[1]/li[1]/ul[1]/li[1]/a[1]"));
        ...
        sendTextTwoElement(By.xpath("//input[@class='qty-input']"), "2");
        ...
        sendTextTwoElement(By.id("BillingNewAddress_FirstName"), firstName); //first name
        sendTextTwoElement(By.id("BillingNewAddress_LastName"), lastName); //Last name

        Random randomGenerator = new Random();
        int counter = randomGenerator.nextInt(9999);
        sendTextTwoElement(By.id("BillingNewAddress_Email"), firstName + lastName + counter + "@email.com");
